...
class nn_processor:
    ...
    def train(self,net,lr=0.01,EPOCH=40,max_iter=500,save_iter=500,first_iter=0,loss_func = nn.CrossEntropyLoss()):
            ...
            for step, mask in enumerate(self.train_loader):
                ...
                if i % 100 == 0:
                    ...
                    if i == max_iter:  # 达到最大迭代，保存模型
                        stop = True
                        torch.save(net.state_dict(), f'encoder/{i+first_iter}.pth')
                        print('\nmodel saved!')
                        break
...
if __name__ == '__main__':
    ...
    encoder_processor.train(net,lr=0.03, EPOCH=400, max_iter=200000, first_iter=first_iter)
